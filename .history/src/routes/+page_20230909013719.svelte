...
<div id="settings-temp" style="display: none;" class="extFrame">
	<center>
		<h1>
			Settings
		</h1>
		...
		<div class="settingCards">
			<div class="settingCard">
				...
				<div class="settingCardButtons">
					<button class="settingCardButton" onclick="window.setTheme('light')">Light</button>
					<button class="settingCardButton" onclick="window.setTheme('dark')">Dark</button>
				</div>
			</div>
			<div class="settingCard">
				<h2>Background</h2>
				<br />
				<div class="settingCardButtons">
					<button class="settingCardButton" onclick="window.setBackground('default')">Default</button>
					<button class="settingCardButton" onclick="window.setBackground('custom')">Custom</button>
				</div>
			</div>
			<div class="settingCard">
				<h2>Search Engine</h2>
				<br />
				<div class="settingCardButtons">
					<button class="settingCardButton" onclick="window.setSearchEngine('google')">Google</button>
					<button class="settingCardButton" onclick="window.setSearchEngine('bing')">Bing</button>
					<button class="settingCardButton" onclick="window.setSearchEngine('duckduckgo')">DuckDuckGo</button>
				</div>
			</div>
			<div class="settingCard">
				<h2>Search Engine</h2>
