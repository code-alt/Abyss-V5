  ...
  if (/^(abyss:)(\/)*[a-z]*/.test(url)) {
    ...
    switch (url) {
      ...
      case "settings":
		...
		settingsTemplate.querySelector("#themeSelect")!.removeAttribute()
        settingsTemplate.querySelector("select").addEventListener("change", () => {
          loadedThemes[settingsTemplate.querySelector("select").value].apply();
        });
...
<div class="abyssCard" id="abyssCardTemplate" style="display: none;">
