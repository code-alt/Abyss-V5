<script lang="ts">
  ...
  setTimeout(
	...
	onMount(async () => {
		var idleTimeout;
document.getElementById("adrbar").addEventListener("input", () => {
...
const recordKeys = (elem) => {
	document.getElementById("adrbar")!.value = "Press a key...";
	document.getElementById("adrbar")!.addEventListener("keydown", (e) => {
		document.getElementById("adrbar").value = e.key;
	});
}
</script>
	...
	<center style="overflow:auto">
		...
		<div class="settingCards">
			...
			<div class="abyssCard">
				...
				<br />
				<h2>Panic Keybind</h2>
				<input type="text" readonly placeholder="Enter key" on:click={recordKeys(this)} />
				<br />
				<h2>Panic Key URL</h2>
...
<datalist id="autofill-results"></datalist>
