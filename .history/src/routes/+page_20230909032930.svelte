...
const openAbtBlank = () => {
	// how do i do this
	// i dont know
	// basically, I want it to open this page, but in about:blank, can you do that for me?
	// yes
	// ok then do it copilot, show me how
	// ok
	// ok but write the code now don't say ok I want the answer
	// ok
	// bruh I am getting paid for this please do it
