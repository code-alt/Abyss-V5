				...
				case 'games':
					...
					extensionsTemplate.querySelector(".gameCategoryButtons")!.querySelectorAll("button").forEach((btn) => {
						btn.addEventListener("click", () => {
							console.log("test " + btn.className)
							extensionsTemplate.querySelector(".gameCategories")!.querySelectorAll("button").forEach((elem) => {
								(elem as HTMLElement).style.display = "none";
							})
							extensionsTemplate.querySelector(".gameCategories")?.querySelectorAll("." btn.className).forEach((elem) => {
